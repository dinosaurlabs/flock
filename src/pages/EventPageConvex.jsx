  ...
  if (!isValidConvexId) {
    return (
      <div className="p-8 text-center">
        <h2 className="text-xl font-bold mb-4">Invalid Event ID</h2>
        <p>This appears to be an old event ID from Supabase.</p>
        <p className="mt-2">Please create a new event using the chatbot.</p>
      </div>
    );
  }
